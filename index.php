...
<div class="container-fluid row" style=" background-image:url('includes/images/image.jpg'); background-repeat: no-repeat; background-size:100% 100%; height: 400px;">
...
<p align="center" style="background-color: rgb(0,0,0);  background-color: rgba(0,0,0, 0.7); color: #FFF; font-size: 30px;font-family: 'Open Sans', sans-serif; font-weight: 900;">RVCE BUY AND SELL BOOKS ONLINE</p>
<!-- search box start -->
